...
class Window(tk.Frame):
    def __init__(self, parent):
        ...
        self.varAllAlgorithms = tk.IntVar(value=0)
        self.varLR = tk.IntVar(value=0)
        self.varLDA = tk.IntVar(value=0)
        self.varKNN = tk.IntVar(value=0)
        self.varGBC = tk.IntVar(value=0)
        self.varDT = tk.IntVar(value=0)
        self.varRF = tk.IntVar(value=0)
        self.varNB = tk.IntVar(value=0)
        self.varSVM = tk.IntVar(value=0)
        ...
        self.checkAllLogarithms = tk.Checkbutton(self.leftFrame, text="All", font=("Arial", 10), variable=self.varAllAlgorithms, onvalue=1, offvalue=0, fg=self.comboColor)
        self.checkAllLogarithms.grid(column=1, row=5, padx=2, pady=2, sticky="e", columnspan=2)
